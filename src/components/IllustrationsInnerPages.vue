...
const props = defineProps({
  drinkType: { type: String, default: 'Vodka' },
})
...
const IllsInnerData = {
  Vodka: {
    ...
    imgs: [{ src: 'images/grade1.png', alt: '香味複雜度' }, { src: 'images/grade1.png', alt: '甜感' }, { src: 'images/grade4.png', alt: '清爽感' }, { src: 'images/grade4.png', alt: '酒精強度' }, { src: 'images/grade1.png', alt: '酒體厚重感' }],
  },
  Gin: {
    zh: '琴酒', en: 'Gin',
    ...
    backgroundImage: 'url(./images/IllustrationsInnerPagesGin.png)',
    imgs: [{ src: 'images/grade4.png', alt: '香味複雜度' }, { src: 'images/grade1.png', alt: '甜感' }, { src: 'images/grade3.png', alt: '清爽感' }, { src: 'images/grade4.png', alt: '酒精強度' }, { src: 'images/grade2.png', alt: '酒體厚重感' }],
  },
  Rum: {
    zh: '蘭姆酒', en: 'Rum',
    ...
    backgroundImage: 'url(./images/IllustrationsInnerPagesRum.png)',
    imgs: [{ src: 'images/grade3.png', alt: '香味複雜度' }, { src: 'images/grade4.png', alt: '甜感' }, { src: 'images/grade2.png', alt: '清爽感' }, { src: 'images/grade4.png', alt: '酒精強度' }, { src: 'images/grade3.png', alt: '酒體厚重感' }],
  },
  Tequila: {
    zh: '龍舌蘭', en: 'Tequila',
    ...
    backgroundImage: 'url(./images/IllustrationsInnerPagesTequila.png)',
    imgs: [{ src: 'images/grade3.png', alt: '香味複雜度' }, { src: 'images/grade2.png', alt: '甜感' }, { src: 'images/grade3.png', alt: '清爽感' }, { src: 'images/grade4.png', alt: '酒精強度' }, { src: 'images/grade3.png', alt: '酒體厚重感' }],
  },
  Whiskey: {
    zh: '威士忌', en: 'Whiskey',
    ...
    backgroundImage: 'url(./images/IllustrationsInnerPagesWhiskey.png)',
    imgs: [{ src: 'images/grade4.png', alt: '香味複雜度' }, { src: 'images/grade2.png', alt: '甜感' }, { src: 'images/grade1.png', alt: '清爽感' }, { src: 'images/grade5.png', alt: '酒精強度' }, { src: 'images/grade4.png', alt: '酒體厚重感' }],
  },
  Brandy: {
    zh: '白蘭地', en: 'Brandy',
    ...
    backgroundImage: 'url(./images/IllustrationsInnerPagesBrandy.png)',
    imgs: [{ src: 'images/grade4.png', alt: '香味複雜度' }, { src: 'images/grade3.png', alt: '甜感' }, { src: 'images/grade1.png', alt: '清爽感' }, { src: 'images/grade4.png', alt: '酒精強度' }, { src: 'images/grade4.png', alt: '酒體厚重感' }],
  },
  Daiquiri: {
    zh: '黛綺麗', en: 'Daiquiri',
    Practice: '黛綺麗起源於19世紀末的<span>古巴</span>，據說由一位美國礦工在Daiquiri鎮發明，後來在哈瓦那的酒吧中廣為流行。',
    Taste: '傳統做法簡單，僅需三種材料：<span>白蘭姆酒</span>、<span>新鮮萊姆汁</span>與<span>糖漿</span>，經搖盪後倒入冷卻杯中即可。這杯調酒完美平衡酸與甜，<span>入口清爽、酒感適中</span>，帶有柑橘與甘蔗的自然風味，是熱帶地區經典的消暑選擇。',
    Suggestions: '品飲建議：用<span>碎冰搖盪</span>後飲用，萊姆汁要<span>新鮮現榨</span>，才能展現最純正的風味。適合在夏天午後或輕鬆聚會中享用。',
    backgroundImage: 'url(./images/IllustrationsInnerPagesDaiquiri.png)',
    imgs: [{ src: 'images/grade3.png', alt: '香味複雜度' }, { src: 'images/grade2.png', alt: '甜感' }, { src: 'images/grade5.png', alt: '清爽感' }, { src: 'images/grade3.png', alt: '酒精強度' }, { src: 'images/grade1.png', alt: '酒體厚重感' }],
  },
  Negroni: {
    zh: '內格羅尼', en: 'Negroni',
    ...
    backgroundImage: 'url(./images/IllustrationsInnerPagesNegroni.png)',
    imgs: [{ src: 'images/grade5.png', alt: '香味複雜度' }, { src: 'images/grade2.png', alt: '甜感' }, { src: 'images/grade2.png', alt: '清爽感' }, { src: 'images/grade5.png', alt: '酒精強度' }, { src: 'images/grade4.png', alt: '酒體厚重感' }],
  },
  Sidecar: {
    zh: '邊車', en: 'Sidecar',
    ...
    backgroundImage: 'url(./images/IllustrationsInnerPagesSidecar.png)',
    imgs: [{ src: 'images/grade4.png', alt: '香味複雜度' }, { src: 'images/grade2.png', alt: '甜感' }, { src: 'images/grade3.png', alt: '清爽感' }, { src: 'images/grade4.png', alt: '酒精強度' }, { src: 'images/grade3.png', alt: '酒體厚重感' }],
  },
  Cosmopolitan: {
    zh: '柯夢波丹', en: 'Cosmopolitan',
    ...
    backgroundImage: 'url(./images/IllustrationsInnerPagesCosmopolitan.png)',
    imgs: [{ src: 'images/grade3.png', alt: '香味複雜度' }, { src: 'images/grade3.png', alt: '甜感' }, { src: 'images/grade4.png', alt: '清爽感' }, { src: 'images/grade3.png', alt: '酒精強度' }, { src: 'images/grade2.png', alt: '酒體厚重感' }],
  },
  LongIslandIcedTea: {
    zh: '長島冰茶', en: 'Long Island Iced Tea',
    ...
    backgroundImage: 'url(./images/IllustrationsInnerPagesLongIslandIcedTea.png)',
    imgs: [{ src: 'images/grade3.png', alt: '香味複雜度' }, { src: 'images/grade4.png', alt: '甜感' }, { src: 'images/grade3.png', alt: '清爽感' }, { src: 'images/grade5.png', alt: '酒精強度' }, { src: 'images/grade3.png', alt: '酒體厚重感' }],
  },
  TequilaSunrise: {
    zh: '龍舌蘭日出', en: 'Tequila Sunrise',
    ...
    backgroundImage: 'url(./images/IllustrationsInnerPagesTequilaSunrise.png)',
    imgs: [{ src: 'images/grade2.png', alt: '香味複雜度' }, { src: 'images/grade5.png', alt: '甜感' }, { src: 'images/grade5.png', alt: '清爽感' }, { src: 'images/grade3.png', alt: '酒精強度' }, { src: 'images/grade2.png', alt: '酒體厚重感' }],
  },
}

const drinkData = computed(() => IllsInnerData[props.drinkType] ?? IllsInnerData.Vodka)
</script>

<template>
  <section class="B_IllustrationsInnerPages">
    <div class="drinkPic" :style="{ backgroundImage: drinkData.backgroundImage }" />
    <div class="B_left">
      <div class="B_title">
        <h2 class="B_titleZh">{{ drinkData.zh }}</h2>
        <h3 class="B_titleEn">{{ drinkData.en }}</h3>
      </div>
      <div class="B_introduceBox">
        <!-- 使用 v-html 對應 React 的 dangerouslySetInnerHTML -->
        <p class="B_introducePractice"   v-html="drinkData.Practice" />
        <p class="B_introduceTaste"      v-html="drinkData.Taste" />
        <p class="B_introduceSuggestions" v-html="drinkData.Suggestions" />
      </div>
    </div>
    <div class="B_right">
      <div v-for="(img, index) in drinkData.imgs" :key="index" class="B_powerImg">
