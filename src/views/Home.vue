...
const IlluData = {
  base: {
    ...
    imgs: [
      ...
      { src: 'images/Gin.png', alt: '琴酒' },
      { src: 'images/Whiskey.png', alt: '威士忌' },
    ],
  },
  classic: {
    zh: '經典調酒',
    ...
    imgs: [
      { src: 'images/Daiquiri.png', alt: '戴綺麗' },
      { src: 'images/Negroni.png', alt: '尼格羅尼' },
      { src: 'images/Sidecar.png', alt: '邊車' },
    ],
  },
  popular: {
    zh: '大眾調酒',
    ...
    imgs: [
      { src: 'images/Cosmopolitan.png', alt: '柯夢波丹' },
      { src: 'images/LongIslandIcedTea.png', alt: '長島冰茶' },
      { src: 'images/TequilaSunrise.png', alt: '龍舌蘭日出' },
    ],
  },
}
